        ...
        <div class="flex items-center gap-4 flex-1 max-w-sm mx-12">
            <div class="relative w-full">
                ...
                <Input placeholder="Search anything"
                    class="pl-10 h-10 bg-[#F1F5F9] dark:bg-white/10 border-none rounded-[14px] focus-visible:ring-1 focus-visible:ring-[#001d22]/5 dark:focus-visible:ring-white/10 text-sm dark:text-white dark:placeholder-neutral-500" />
                <div
