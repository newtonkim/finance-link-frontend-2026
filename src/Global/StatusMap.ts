export const status = {
  ...
  expired: {
    label: 'expired',
    className:
      ' text-xs font-bold px-2 py-1 rounded-full bg-rose-50 text-rose-700 dark:bg-rose-500/10 dark:text-rose-400',
  },
  trial: {
    label: 'transit',
    className:
      ' text-xs font-bold px-2 py-1 rounded-full bg-amber-50 text-amber-700 dark:bg-amber-500/10 dark:text-amber-400',
  },
  basic: {
    label: 'basic',
  ...
  enterprise: {
    label: 'enterprise',
    className:
      'text-xs font-bold px-2 py-1 rounded-full bg-amber-500/10 text-neutral-700 shadow-sm',
  },
  professional: {
  ...
  suspended: {
    label: 'Suspended',
    className:
      ' text-xs font-bold px-2 py-1 rounded-fullbg-orange-50 text-orange-700 dark:bg-orange-500/10 dark:text-orange-400   ',
  },
  fired: {
    label: 'Fired',
...
export const paymentMethods = {
  ...
  mobile_money: {
    label: 'Mobile Money',
    className: ' font-bold px-0 py-1 rounded-full  text-blue-700',
  },
}
