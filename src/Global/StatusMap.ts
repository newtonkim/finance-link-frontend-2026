export const status = {
  pending: {
    label: 'Pending',
    className: ' text-sm font-medium px-3 text-sm py-1 rounded-full   bg-yellow-100 text-yellow-700',
  },
  active: {
    label: 'Active',
  ...
  expired: {
    label: 'expired',
    className:
      ' text-sm font-medium px-3 text-sm py-1 rounded-full bg-rose-50 text-rose-700 dark:bg-rose-500/10 dark:text-rose-400',
  },
  trial: {
    label: 'transit',
    className:
      ' text-sm font-medium px-3 text-sm py-1 rounded-full bg-amber-50 text-amber-700 dark:bg-amber-500/10 dark:text-amber-400',
  },
  basic: {
    label: 'basic',
    className: 'text-sm font-medium px-3 text-sm py-1 rounded-full bg-white text-amber-700 shadow-sm',
  },
  enterprise: {
    label: 'enterprise',
    className:
      'text-sm font-medium px-3 text-sm py-1 rounded-full bg-amber-500/10 text-neutral-700 shadow-sm',
  },
  professional: {
    label: 'Pending Approval',
    className: 'text-sm font-medium px-3 text-sm py-1 rounded-full bg-yellow-100 text-yellow-700 shadow-sm',
  },
  suspended: {
    label: 'Suspended',
    className:
      ' text-sm font-medium px-3 text-sm py-1 rounded-fullbg-orange-50 text-orange-700 dark:bg-orange-500/10 dark:text-orange-400   ',
  },
  fired: {
    label: 'Fired',
    className: ' text-sm font-medium px-3 text-sm py-1 rounded-full bg-red-100 text-red-700',
  },
  failed: {
    label: 'Failed',
    className: 'text-sm font-medium px-3 text-sm py-1 rounded-full bg-red-100 text-red-600',
  },
}
...
export const paymentStatus = {
  ...
  paid: {
    label: 'Paid',
    className: 'text-sm font-medium px-3 text-sm py-1 rounded-full bg-green-100 text-green-700',
  },
  completed: {
    label: 'completed',
    className: 'text-sm font-medium px-3 text-sm py-1 rounded-full bg-green-200 text-green-700',
  },
  partially_paid: {
  ...
  refunded: {
    label: 'Refunded',
    className: 'text-sm font-medium px-3 text-sm py-1 rounded-full bg-blue-100 text-blue-700',
  },
  failed_payment: {
...
export const paymentMethods = {
  cash: { label: 'Cash', className: ' font-medium px-3 text-sm py-1 rounded-full     text-green-700' },
  card: { label: 'Card', className: '  font-medium px-3 text-sm py-1 rounded-full  text-blue-600' },
  bank: { label: 'Bank', className: '  font-medium px-3 text-sm py-1 rounded-full  text-blue-600' },
  mobile_money: {
    label: 'Mobile Money',
...
export const systemRoles = {
  admin: {
    label: 'admin',
    className: 'font-medium px-3 text-sm py-1 rounded-full text-purple-700',
  },

  'super-admin': {
    label: 'supper admin',
    className: 'font-medium px-3 text-sm py-1 rounded-full text-neutral-600/60',
  },

  ordinary: {
    label: 'Ordinary',
    className: 'font-medium px-3 text-sm py-1 rounded-full text-teal-600',
  },

  manager: {
    label: 'Manager',
    className: 'font-medium px-3 text-sm py-1 rounded-full text-red-600',
  },

  accountant: {
    label: 'Accountant',
    className: 'font-medium px-3 text-sm py-1 rounded-full text-indigo-600',
  },
}
