<template>
    <div class="space-y-4  capitalize h-sc reen flex flex-col">
        <section v-for="(section, sIndex) in columns" :key="sIndex" class="overflow-hidden rounded-lg r border-neutral-200 dark:border-neutral-700   dark:bg-neutral-900  
           flex flex-col   rounded-2xl border-neutral-100 bg-white  shadow-lg   pb-5 dark:border-neutral-800 dark:bg-neutral-900
            ">
            ...
            <div v-if="section.type.toLocaleLowerCase() === 'table'" class=" overflow-auto h-full  ">
            ...
            <div v-else-if="section.type.toLocaleLowerCase() === 'descriptions' " class=" h-full  ">
