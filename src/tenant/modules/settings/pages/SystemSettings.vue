...
<template>
  <div class="flex h-full flex-1 flex-col gap-6 p-4 md:p-6">
    ...
    <div class="flex justify-end">
      <button class="rounded-xl  bg-nfuko-primary px-6 py-2.5 text-sm font-semibold text-white shadow-sm transition-all hover:bg-[#002e35] active:scale-[0.98] dark:bg-nfuko-yellow dark:text-[#1d4780] dark:hover:bg-[#b8973f]">
        Save Changes
      </button>
    </div>
  </div>
