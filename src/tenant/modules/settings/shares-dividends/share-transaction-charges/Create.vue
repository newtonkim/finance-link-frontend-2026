...
<template>
  ...
  <div class="  ">
    ...
    >
      <div class="flex justify-between items-center px-4 py-2 border-b border-gray-200 dark:border-neutral-700 bg-gray-50 dark:bg-neutral-900">
        ...
        <button
          ...
          class="text-xs text-nfuko-danger hover:underline"
        >
          Remove
        </button>
      </div>
      ...
      <div class="p-4">
        ...
        <Form
          :action="data?.action"
          parentStyle="grid grid-cols-1 xl:grid-cols-6 sm:grid-cols-2 md:grid-cols-3 gap-5"
