    ...
    <div class="bg-white dark:bg-neutral-900 border border-neutral-100 dark:border-neutral-800 rounded-2xl p-6">
      ...
      <div v-else class="space-y-6">
        ...
        <div class="flex items-center justify-between mt-4">
          <button @click="addLevel" class="bg-nfuko-primary text-white dark:bg-nfuko-yellow dark:text-[#0A2318] px-5 py-2.5 rounded-xl font-semibold shadow-sm hover:bg-[#002e35] dark:hover:bg-[#b8973f] flex items-center gap-2 transition-all text-sm">
            <Plus class="w-4 h-4" />
            Add Approval Level
          </button>
          
          <button @click="saveThresholds" :disabled="saving" class="bg-nfuko-primary text-white dark:bg-nfuko-yellow dark:text-[#0A2318] px-6 py-2.5 rounded-xl font-semibold shadow-sm hover:bg-[#002e35] dark:hover:bg-[#b8973f] disabled:opacity-70 flex items-center gap-2 transition-all">
