...
import { Calendar, Filter, Download, AlertTriangle, TrendingUp } from 'lucide-vue-next'
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
      <div>
        ...
        <p class="text-sm text-neutral-500 dark:text-neutral-400">
          Portfolio at risk grouped by days past due. Includes PAR, provisioning, and per-installment arrears.
        </p>
      </div>
      <button
        @click="exportCsv"
    ...
    <template v-else>
      <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
        ...
        <div class="rounded-2xl border border-neutral-100 bg-white p-5 shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
          ...
          <p class="mt-1 text-xs text-neutral-400">{{ totals.loan_count }} active loans</p>
        </div>
        ...
        >
          ...
          <p class="mt-1 text-xs text-neutral-400">Loans &gt;30 days overdue</p>
        </div>
        ...
        >
          ...
          <p class="mt-1 text-xs text-neutral-400">Loans &gt;90 days overdue</p>
        </div>
      </div>
          ...
          <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-neutral-50 dark:divide-neutral-800">
              ...
              <tr class="border-t-2 border-neutral-200 bg-neutral-50 font-semibold dark:border-neutral-700 dark:bg-neutral-800/60">
                ...
                <td class="px-6 py-3 text-right text-neutral-900 dark:text-white">{{ totals.loan_count }}</td>
            ...
            <table class="w-full text-sm">
              <thead>
                <tr class="bg-neutral-50 dark:bg-neutral-800/40">
                  ...
                  <th class="px-5 py-3 text-right text-xs font-semibold uppercase tracking-wide text-neutral-400">Outstanding</th>
                  <th class="px-5 py-3 text-right text-xs font-semibold uppercase tracking-wide text-neutral-400">Arrears</th>
                  <th class="px-5 py-3 text-right text-xs font-semibold uppercase tracking-wide text-neutral-400">DPD</th>
                  <th class="px-5 py-3 text-center text-xs font-semibold uppercase tracking-wide text-neutral-400">Bucket</th>
              ...
              <tr
                ...
                >
                  <!-- Member -->
                  <td class="px-5 py-3">
                    <div class="font-medium text-neutral-900 dark:text-white">{{ row.member_name }}</div>
                  ...
                  <!-- Outstanding -->
                  <td class="px-5 py-3 text-right font-mono text-neutral-900 dark:text-white">
                    {{ fmt(row.outstanding_balance) }}
                  </td>

                  <!-- Arrears — expandable tooltip on hover -->
