            ...
            <table class="w-full text-left min-w-[900px]">
                <thead>
                    <tr class="border-b border-gray-100 bg-transparent text-[#64748b]">
                        ...
                        <th class="py-4 px-6 text-[11px] font-bold uppercase tracking-wider">Amount Deposited &#x21C5;</th>
                        <th class="py-4 px-6 text-[11px] font-bold uppercase tracking-wider">Charge &#x21C5;</th>
                        <th class="py-4 px-6 text-[11px] font-bold uppercase tracking-wider">Amount After Charges &#x21C5;</th>
                        <th class="py-4 px-6 text-[11px] font-bold uppercase tracking-wider">Running blc &#x21C5;</th>
                    ...
                    <tr v-for="(txn, index) in paginated" :key="txn.id"
                        ...
                        <!-- <td class="py-3.5 px-5">
                         ...
                         <td class="py-3.5 px-5">
                            <span class="text-[14px] font-mono font-bold"
                                >
                                {{ formatCurrency(txn.amount_before_charge) }}
                            </span>
                        </td>
                        ...
                        <td class="py-3.5 px-5 text-[13px] text-foreground">
                            ...
                            <div v-if="!txn?.type.includes('charge')" >{{formatCurrency( Number(txn.amount??0)+Number(txn.running_balance??0) )}}</div> 
                            <div v-else >-</div> 
                        </td>
                        <!-- Description -->
                        <td class="py-3.5 px-5 text-[13px] text-foreground">
