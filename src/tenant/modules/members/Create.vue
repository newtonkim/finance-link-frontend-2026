...
<template>
    ...
    <div class="card shadow-md p-4 py-10 bg-white dark:bg-neutral-800 rounded-md">
        ...
        @results="validateChanges"
         :action="data?.action" v-else parentStyle="grid  grid-cols-2 gap-4 md:gap-6" v-model:form="fields" />
              ...
              <div v-setting='"sacco-share-on-member-creation-create-share-account-at-the-same-time"' class="mt-6 rounded-2xl border border-nfuko-primary-200 bg-nfuko-primary-50/60 overflow-hidden">
          <!-- Section header -->
          <div class="flex items-center gap-2.5 px-5 py-3 bg-nfuko-primary-100/80 border-b border-nfuko-primary-200">
            ...
            <span class="ml-auto inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold bg-nfuko-primary-600 text-white uppercase tracking-wide">
              Required
            </span>
          </div>
  ...
  <p class="text-[12px] text-nfuko-primary-800 leading-relaxed">
    ...
    <strong>
      UGX {{
      ( settingList?.['sacco-share-price-value']??1) * (settingList?.['sacco-share-on-member-creation-create-share-minimum-value']??0)
      }}
    </strong>)
            ...
            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
              ...
              <div class="grid gap-1.5">
                ...
                <div class="flex overflow-hidden rounded-xl border focus-within:ring-1 transition-all"
                  ...
                  <input
                    v-model.number="additionalForm.shares_quantity"
                    type="number"
              ...
              <div class="grid gap-1.5">
                ...
                <div class="flex items-center gap-3 rounded-xl border border-nfuko-primary-200 bg-white px-4 py-3 min-h-[48px]">
                  ...
                  <div>
                    ...
                    <p class="text-[18px] font-black text-nfuko-primary-700 font-mono leading-tight">
                      UGX {{ additionalForm.shares_quantity*settingList?.['sacco-share-price-value']?.toLocaleString('en-US', { minimumFractionDigits: 2 }) }}
                    </p>
                  </div>
                </div>
              </div>
