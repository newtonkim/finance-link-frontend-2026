      ...
      <div class="flex-1 overflow-hidden px-10 pb-6 pt-6">
        ...
        <div class="flex items-center justify-between mb-2 max-w-6xl mr-auto ml-6">
          <div class="flex flex-col gap-2">
            <h1 class="text-[26.5px] font-black text-[#0050D8] tracking-tight italic leading-tight">Edit Group</h1>
          ...
          <div class="flex-1 -mt-6 flex flex-col gap-6 pb-2 px-2">
            ...
            <div class="flex items-center justify-between gap-3 mt-4 pt-1">
              ...
              <button
                @click="handleSubmit"
                :disabled="processing"
                class="flex items-center gap-3 px-10 py-3.5 text-sm font-bold text-white bg-[#052659] rounded-2xl hover:bg-[#052659]/90 transition-all shadow-xl shadow-[#052659]/10 active:scale-95 disabled:opacity-70"
              >
