<template>
    <TableDrawer drawerWidth=" w-1/3" :url="tableUrl" state="memberAccountList" :drawerTitle="drawerTitle" " :columns="
...
<div><h1 class="text-2xl font-bold text-neutral-900 dark:text-white">Members Savings Account</h1><p class="text-sm text-neutral-500 dark:text-neutral-400">Manage all member savings accounts and their balances.</p></div>
</template>
...
const formData = ref<Record<string, any>>({}), statusFilter = ref('all'),
 ...
 title: Record<string, string> = {
    "view": "Viewmember saving's Account Details",
    "edit": "Edit member saving's Account",
    "add": "Create a member saving's Account",
}
