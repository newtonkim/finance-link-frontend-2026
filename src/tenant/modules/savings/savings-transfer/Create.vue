        ...
        <div class="bg-white rounded-2xl shadow-sm border border-neutral-100 p-5 space-y-4">
          ...
          <div class="space-y-3">
            <div class="flex items-start gap-3">
              <div
                class="w-6 h-6 rounded-full  bg-nfuko-primary text-white text-[11px] font-bold flex items-center justify-center shrink-0 mt-0.5">
                1</div>
              <p class="text-[12px] text-neutral-500 leading-relaxed">Select the source account to transfer <strong
                  class="text-neutral-700">from</strong>.</p>
            </div>
            <div class="flex items-start gap-3">
              <div
                class="w-6 h-6 rounded-full  bg-nfuko-primary text-white text-[11px] font-bold flex items-center justify-center shrink-0 mt-0.5">
                2</div>
              <p class="text-[12px] text-neutral-500 leading-relaxed">Select the destination account to transfer <strong
                  class="text-neutral-700">to</strong>.</p>
            </div>
            <div class="flex items-start gap-3">
              <div
                class="w-6 h-6 rounded-full  bg-nfuko-primary text-white text-[11px] font-bold flex items-center justify-center shrink-0 mt-0.5">
                3</div>
              <p class="text-[12px] text-neutral-500 leading-relaxed">Enter the amount and submit. Both accounts update
                instantly.</p>
            </div>
          </div>
        </div>
