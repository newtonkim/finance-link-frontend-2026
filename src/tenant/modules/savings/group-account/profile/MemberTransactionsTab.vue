<template>
    <TableDrawer :downloadItems="downloadItems" :printItems="printItems" :showAddButton="false" :importDefaults="['id', 'branch_id', 'dob']"
        drawerWidth=" w-2/3" :url="tableUrl" state="groupdAccountTransactions" :drawerTitle="drawerTitle"
        :columns="columns" :showTableAction="['download', 'print']">
