      ...
      <div class="flex flex-col gap-6">
        ...
        >
          ...
          <p class="mb-4 text-xs text-green-700 dark:text-green-400">
            ...
            for <strong>{{ application.approved_term }} months</strong>. Process disbursement to
        ...
        <div
          v-if="application.status !== 'disbursed' && application.approvals?.length"
          class="rounded-2xl border border-neutral-100 bg-white p-6 shadow-sm dark:border-neutral-800 dark:bg-neutral-900"
        >
        ...
        <div
          v-if="application.status !== 'disbursed' && committeeVotes?.length"
          class="rounded-2xl border border-neutral-100 bg-white p-6 shadow-sm dark:border-neutral-800 dark:bg-neutral-900"
        >
          <h2 class="mb-4 text-base font-semibold text-neutral-900 dark:text-white">
            Committee Votes
