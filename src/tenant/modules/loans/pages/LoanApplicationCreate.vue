...
import { ArrowLeft, HandCoins, Save, ChevronDown, Loader2, Calculator } from 'lucide-vue-next'
...
function onAmountFocus() {
    // Strip formatting so user sees raw digits
...
<template>
    <div class="flex h-full flex-1 flex-col gap-6 bg-[#f8faf9] p-4 md:p-6 dark:bg-[#0a0a0a]">
        ...
        <form class="grid gap-6 xl:grid-cols-[minmax(0,1fr)_360px]" @submit.prevent="save">
