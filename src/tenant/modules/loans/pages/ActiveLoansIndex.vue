...
const { loading, loans, meta, filters, activeTab, summary, fetch, switchTab, applyFilters } = useActiveLoans()
...
function statusBadge(status: string) {
    switch (status) {
        ...
        case 'arrears':      return 'bg-red-100 text-red-700'
...
<template>
    <div class="flex flex-col h-full">
        ...
        <!-- Tab bar -->
        <div class="border-b border-neutral-200 bg-white dark:border-neutral-800 dark:bg-neutral-950 px-4 sm:px-6">
        ...
        <div class="flex-1 overflow-auto p-4 sm:p-6 space-y-4">
            ...
            <div class="rounded-2xl border border-neutral-100 bg-white dark:border-neutral-800 dark:bg-neutral-900 overflow-hidden">
                ...
                <!-- Empty -->
                <div v-else-if="!loans.length" class="flex flex-col items-center justify-center py-20 gap-3 text-neutral-400">
                ...
                <div v-else class="overflow-x-auto">
                    <table class="w-full text-sm">
                        <thead class="border-b border-neutral-100 dark:border-neutral-800">
                            <tr class="text-left text-xs font-semibold text-neutral-500 dark:text-neutral-400 uppercase tracking-wider">
                        ...
                        <tbody class="divide-y divide-neutral-50 dark:divide-neutral-800/60">
                            ...
                            >
                                ...
                                <td class="px-4 py-3">
                                    <p class="font-medium text-neutral-900 dark:text-white">{{ loan.member?.name ?? '—' }}</p>
                                ...
                                <td
                                    ...
                                    :class="loan.status === 'arrears' ? 'text-red-600 dark:text-red-400' : 'text-neutral-800 dark:text-neutral-200'"
                                >
                                ...
                                <td class="px-4 py-3">
                                    <button
                                        ...
                                        @click="loan._source === 'application'
                                            ? router.push({ name: 'tenant-loan-application-show', params: { id: String(loan.id) } })
                                            : router.push({ name: 'tenant-loan-account', params: { id: String(loan.id) } })"
                                    >
                                        Action
                                    </button>
                                </td>
            ...
            <!-- Pagination -->
            <div v-if="meta.total > 0" class="flex items-center justify-between text-sm text-neutral-500 dark:text-neutral-400">
                <span>
