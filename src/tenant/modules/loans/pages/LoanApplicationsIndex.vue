<template>
  <TableDrawer ref="drawer" :exportItems="exportItems" :drawerShowFooter="false"
    :importDefaults="['id', 'branch_id', 'dob']" drawerWidth="w-4/5" :url="tableUrl" state="LoanApplicationslist"
