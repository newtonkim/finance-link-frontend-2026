                ...
                <div class="w-full max-w-md rounded-2xl border border-neutral-200 bg-white shadow-xl dark:border-neutral-700 dark:bg-neutral-900">
                    ...
                    <div class="px-6 py-5">
                        ...
                        <textarea v-model="bmNotes" rows="4" placeholder="Add any notes for the committee…"
                            class="mt-2 w-full rounded-xl border border-neutral-200 px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-300/50 dark:border-neutral-700 dark:bg-neutral-800 dark:text-white" />
                    </div>
                    <div class="flex justify-end gap-3 border-t border-neutral-100 px-6 py-4 dark:border-neutral-800">
                        ...
                        <button :disabled="submitting"
                            class="flex items-center gap-2 rounded-xl bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-[#052659]/90 disabled:opacity-50"
                            @click="handleSubmit">
