...
import { ref } from 'vue'
import { ArrowLeft, CreditCard, Plus, Save, ChevronDown, ChevronUp } from 'lucide-vue-next'
...
import LoanProductPreview from '../components/LoanProductPreview.vue'
    ...
    <form v-else class="grid gap-6 xl:grid-cols-[minmax(0,1fr)_360px]" @submit.prevent="save">
        ...
        >
          ...
          <div class="grid gap-4 sm:grid-cols-2">
            ...
            <div>
              ...
              />
              <p class="mt-1 text-xs text-neutral-400 dark:text-neutral-500">
                Days beyond due date before penalty or cancellation.
              </p>
            </div>
            <div>
              <label class="mb-1 block text-sm font-medium text-neutral-700 dark:text-neutral-300"
          ...
          <div class="mt-6">
            <div class="mb-4 flex items-center justify-between">
              <div>
                ...
                <p class="text-xs text-neutral-500 dark:text-neutral-400">
                  Optional detailed late-payment rules.
                </p>
              </div>
              <button
                type="button"
      ...
      <div class="space-y-6">
        <LoanProductPreview
          ...
          v-model:preview-amount="previewAmount"
          v-model:preview-term="previewTerm"
          :interest-method="form.interest_method"
          :repayment-structure="form.repayment_structure"
        />
      </div>
    </form>
  </div>
