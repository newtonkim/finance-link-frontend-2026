...
import { TableDrawer,Table,Imploading, StatusButtonsHorizontal, CopyData,TabelActionButtons,DetailsTable,Form,PainPageHeader } from '@/Global'
// TableDrawer, StatusButtonsHorizontal, setLocalValues, PainPageHeader
